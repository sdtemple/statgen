...
```{r}
data <- vcf_preproc('H2/chr22_jpt_maf0.05/chr22_jpt_maf0.05.vcf')
```
...
Accuracy check
```{r}
GRM <- read_GRMBin('~/UW/Student/STAT 551/H/H2/chr22_jpt_maf0.05/chr22_jpt_maf0.05.grm')
...
plink_hom <- read.table('~/UW/Student/STAT 551/H/H2/chr22_jpt_maf0.05/chr22_jpt_maf0.05.het',
                        header = TRUE)$F
